...
"[project]/tinylink/TinyLink/app/api/links/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        const link = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$tinylink$2f$TinyLink$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLink"])({
            url: longUrl,
            code: customCode
        });
...
async function GET() {
    const links = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$tinylink$2f$TinyLink$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLinks"])();
    return __TURBOPACK__imported__module__$5b$project$5d2f$tinylink$2f$TinyLink$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(links);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8b630cbe._.js.map